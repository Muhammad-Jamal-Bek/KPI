...
// Base
const EmployeesKPI = React.lazy(() => import('./views/components/base/accordion/EmployeesKPI'))
const Reports = React.lazy(() => import('./views/components/base/breadcrumbs/Reports'))
...
const KPI_Input = React.lazy(() => import('./views/components/base/tables/KPI_Input'))
...
const routes = [
  ...
  { path: '/employeesKPI', name: 'EmployeesKPI', component: EmployeesKPI },
  ...
  { path: '/KPI_Input', name: 'KPI_Input', component: KPI_Input },
